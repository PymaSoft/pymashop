...
<head>
    ...
    <meta name="description" content="Pyma Shop template">
        ...
        <div class="menu">
            ...
            <div class="menu_search">
                <form action="#" id="menu_search_form" class="menu_search_form">
                    ...
                    <button class="menu_search_button"><img src="http://pymashop.pym/asset/images/search.png"
                            alt=""></button>
                </form>
            </div>
            <!-- Navigation -->
            ...
            <div class="menu_contact">
                <div class="menu_phone d-flex flex-row align-items-center justify-content-start">
                    <div>
                        <div><img src="http://pymashop.pym/asset/images/phone.svg"
                    ...
                    <div class="logo">
                        <a href="#">
                            <div class="d-flex flex-row align-items-center justify-content-start">
                                <div><img src="http://pymashop.pym/asset/images/logo_1.png" alt=""></div>
                                <div>Pyma Shop</div>
                            </div>
                        </a>
                    </div>
                        ...
                        <div class="header_search">
                            <form action="#" id="header_search_form">
                                ...
                                <button class="header_search_button"><img
                                        src="http://pymashop.pym/asset/images/search.png" alt=""></button>
                            </form>
                        </div>

                        <!-- Cart -->
                        <div class="cart"><a href="cart.html">
                                <div><img class="svg" src="http://pymashop.pym/asset/images/cart.svg"
                                        ...
                                        <a href="#">
                                            <div class="d-flex flex-row align-items-center justify-content-start">
                                                <div class="footer_logo_icon"><img
                                                        src="http://pymashop.pym/asset/images/logo_2.png" alt=""></div>
                                                <div>Pyma Shop</div>
                                            </div>
                                        </a>
                                    </div>
