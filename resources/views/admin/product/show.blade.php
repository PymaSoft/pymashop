                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly class="form-control" type="number" id="quantity" name="quantity" value="{{ $producto->quantity }}">
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                <!-- /.col -->
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input readonly v-model="price_previous" class="form-control" type="number"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input readonly v-model="price_current" class="form-control" type="number"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input readonly v-model="discount_percentage" class="form-control" type="number"
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea readonly class="form-control ckeditor" name="short_description"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea readonly class="form-control ckeditor" name="long_description"
                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea readonly class="form-control ckeditor" name="specs" id="specs" rows="3">
                                            {!! $producto->specs !!}
                                        </textarea>
                                    </div>
                                    <!-- /.form group -->
                                    <div class="form-group">
                                        ...
                                        <textarea readonly class="form-control ckeditor" name="data_of_interest"
                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input readonly type="file" class="form-control-file" name="imagenes[]" id="imagenes[]" multiple
                                    accept="image/*">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group clearfix">
                                        <div class="custom-control custom-checkbox">
                                            <input disabled type="checkbox" class="custom-control-input" id="active" name="active"
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input disabled type="checkbox" class="custom-control-input" id="slidermain"
                                                name="slidermain"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-outline-success float-right" href="{{ route('admin.product.edit', $producto->slug) }}">Editar</a>
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                <!-- /.col -->
