        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                _this2.SubmitForm(); //$nextTick sirve para esperar que luego que se actualice el Dom se ejecute una función.                       
  ...
  computed: {
    ...
    generardescuento: function generardescuento() {
      if (this.discount_percentage > 100) {
        ...
        this.descuento = this.price_previous * this.discount_percentage / 100;
        this.price_current = this.price_previous - this.descuento;
...
module.exports = __webpack_require__(/*! C:\laragon\www\pymashop\resources\js\app_admin.js */"./resources/js/app_admin.js");
